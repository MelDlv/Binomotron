...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            rs1 = st.executeQuery("SELECT * FROM apprenants;");

            while (rs1.next()) {
                liste_apprenants.add(rs1.getString("prenom") + " " + (rs1.getString("nom")));
            }
            ...
            for (i = 0; i < liste_apprenants.size(); ) {
                String requete = "INSERT INTO apprenant_groupe(id_apprenant, id_groupe, id_projet) VALUES(id_apprenant, id_groupe, id_projet)";
